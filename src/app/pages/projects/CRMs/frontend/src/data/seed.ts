import type { Interaction, Lead, Stage, User } from '../types';

/**
 * Seed hardcodeado (sin SQLite). En producción real: PostgreSQL.
 * users(id, nombre, email, password_hash, rol)
 * stages(id, nombre_etapa, orden)
 * leads(id, nombre, empresa, telefono, email, fuente, fecha_creacion, asignado_a, etapa_id)
 * interactions(id, cliente_id, usuario_id, tipo, descripcion, fecha)
 */
